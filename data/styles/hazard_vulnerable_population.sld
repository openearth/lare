    ...
    <UserStyle>
      ...
      <se:FeatureTypeStyle>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>hazard_aggregated &gt; 0 and count between 0 and 1000</se:Title>
          </se:Description>
          <ogc:Filter>
            <ogc:And>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>hazard_aggregated &gt; 0 and count between 1000 and 2500</se:Title>
          </se:Description>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>hazard_aggregated &gt; 0 and count between 2500 and 5000</se:Title>
          </se:Description>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
        ...
        <se:Rule>
          ...
          <se:Description>
            <se:Title>hazard_aggregated &gt; 0 and count &gt; 5000</se:Title>
          </se:Description>
          <ogc:Filter>
            <ogc:And>
              <ogc:PropertyIsGreaterThan>
